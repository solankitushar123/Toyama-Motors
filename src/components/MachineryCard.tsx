...
import type { MachineryCategory } from "../data/machinery";

export default function MachineryCard({ category }: { category: MachineryCategory }) {
  return (
    <div className="group bg-paper border border-line rounded-card overflow-hidden hover:shadow-card transition-shadow duration-300">
      <div className="relative aspect-[4/3] overflow-hidden bg-mist">
        <img
          src={category.image}
          alt={`${category.name} sourced by Toyama Motors`}
          loading="lazy"
